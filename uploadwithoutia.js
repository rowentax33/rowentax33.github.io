document.addEventListener("DOMContentLoaded", () => {
  ...
  const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndhbGpxYXhrYnZ6aWRrcnpiY2J6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg4OTA3MDcsImV4cCI6MjA4NDQ2NjcwN30.9lBgfkJMCLk2D-gXjxj9bV5b5x-HZxY_cEBrdlsExBw"; // je te conseille de la remettre proprement
    ...
    try {
      ...
      const res = await fetch(
        "https://waljqaxkbvzidkrzbcbz.functions.supabase.co/upload-to-zerostorage",
        {
          method: "POST",
          headers: {
            "Authorization": "Bearer TA_ANON_KEY_ICI"
          },
          body: formData
        }
      );
